...
export default function EditApprovalPop({student_id, activities_id, onUpdate,year_id}) {
    ...
    return (
        <>
        <Button variant="dark" size="lg" onClick={handleShow} disabled={activeYear !=year_id} className="approve-button">
            Edit Approval
        </Button>
