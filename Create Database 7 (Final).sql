...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `goforgolddb`.`categories` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `goforgolddb`.`activities` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `goforgolddb`.`user_role` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `goforgolddb`.`users` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `goforgolddb`.`school_years` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `goforgolddb`.`student_enrollment` ;
...
CREATE TABLE IF NOT EXISTS `goforgolddb`.`student_enrollment` (
  ...
  PRIMARY KEY (`student_id`, `activities_id`, `year_id`),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `goforgolddb`.`attendance` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `goforgolddb`.`faculty_moderators` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `goforgolddb`.`student_grades` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `goforgolddb`.`honor_roll` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `goforgolddb`.`honor_list` ;
